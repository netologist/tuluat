...
/**
 * Recursive character chunker: splits on paragraph, newline, sentence, and
 * word boundaries, falling back to hard character splits. Chunks are sized to
...
public class RecursiveCharacterChunker implements Chunker {
    ...
    /** Separators tried in order: paragraph, newline, sentence, word, then hard split. */
