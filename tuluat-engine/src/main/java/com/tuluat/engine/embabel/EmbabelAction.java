...
public class EmbabelAction {
	...
	public EmbabelAction(String name, String agentRef, String inputTemplate, String outputKey,
	...
	public List<String> getRequiredPreconditions() {
		return requiredPreconditions;
	}
}
