...
class AgentExecutionServiceTest {
    ...
    void setUp() {
        ...
        agentExecutionService = new AgentExecutionService(
            skillRegistry,
            null, // no Spring AI ChatModel bean in unit test -> simulated execution
    ...
    void testProcessAgentPrompt() {
        ...
        provider.setSpec(new LlmProviderSpec("OPENAI", "https://api.openai.com/v1", null, "gpt-3.5-turbo", 0.7, 2048, 0.0, 0.0, List.of()));
