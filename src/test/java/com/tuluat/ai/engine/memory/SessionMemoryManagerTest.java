package com.tuluat.ai.engine.memory;

import com.tuluat.ai.entity.SessionShortMemoryEntity;
import com.tuluat.ai.repository.SessionShortMemoryRepository;
...
class SessionMemoryManagerTest {
    ...
    void testSaveShortMemory() {
        ...
        SessionShortMemoryEntity result = memoryManager.saveShortMemory(sessionId, "researcher-agent", "assistant", "Research result");
    ...
    void testGetShortMemory() {
        ...
        when(shortMemoryRepository.findBySessionIdOrderByCreatedAtAsc(sessionId))
