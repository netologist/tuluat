...
import com.tuluat.ai.crd.agent.AiAgentStatus;
...
public class AiAgentReconciler implements Reconciler<AiAgent> {
        ...
        Deployment deployment = new DeploymentBuilder()
            ...
            .withNewSpec()
                ...
                .withNewTemplate()
                    ...
                    .endMetadata()
                    .withNewSpec()
                        .withServiceAccountName("k8s-ai-operator-sa")
                        .addNewContainer()
                            .withName("ai-agent-app")
                            .withImage("k8s-crd-ai-operator:latest")
    ...
    private String reconcileIngress(AiAgent agent, OwnerReference ownerRef, String ns) {
        ...
        String host = (ingressSpec.host() != null && !ingressSpec.host().isBlank()) ? ingressSpec.host() : "ai-agent.tuluat.com";
