...
/**
 * Guardrails policy block for an AiAgent (optional; platform defaults apply
 * when absent).
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public record GuardrailsConfig(@JsonProperty("piiMasking") PiiMaskingConfig piiMasking,
