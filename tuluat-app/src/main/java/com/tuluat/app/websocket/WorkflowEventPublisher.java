...
public class WorkflowEventPublisher {
    ...
    public void publishSessionState(UUID sessionId, String workflowName, String phase, String currentNode, Object output) {
    ...
    private void sendToTopic(String destination, Object payload) {
        if (messagingTemplate != null) {
            try {
                ...
                log.warn("Failed to broadcast WebSocket STOMP event to destination {}: {}", destination, e.getMessage());
            }
        }
    }
}
