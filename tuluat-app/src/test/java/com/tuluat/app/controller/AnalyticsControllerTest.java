...
class AnalyticsControllerTest {
    ...
    void testListProviders() {
        ...
        provider.setMetadata(new ObjectMetaBuilder().withName("openai-provider").withNamespace("tuluat-system").build());
        provider.setSpec(new LlmProviderSpec("OPENAI", "https://api.openai.com/v1", null, "gpt-4o", 0.7, 2048, 0.0025, 0.01, List.of()));
