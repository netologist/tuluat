...
class AgentChatControllerTest {
	...
	void testChatWithExistentAgent() {
		...
		agent.setSpec(new AiAgentSpec(new ProviderRef("openai-provider", "default"), "gpt-4o", "System prompt",
				"User prompt", List.of(), List.of(), List.of(new ToolDefinition("calculator", "Math", true, Map.of())),
				List.of(), // toolSources
				List.of(), // mcpServers
				null, // guardrails
				null, // a2a
		...
		when(agentExecutionService.processAgentPrompt(any(), any(), anyString(), isNull()))
