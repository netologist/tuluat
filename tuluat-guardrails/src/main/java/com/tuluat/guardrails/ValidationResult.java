 ...
 *
 * @param valid
 *            whether the output satisfied its JSON schema
 * @param confidence
 *            0.0..1.0 score (1.0 for schema-valid output)
 * @param errors
 *            validation errors (empty when valid)
 * @param filterName
 *            originating filter
 */
public record ValidationResult(boolean valid, double confidence, List<String> errors, String filterName) {
