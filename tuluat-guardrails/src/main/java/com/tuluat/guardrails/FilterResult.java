 ...
 *
 * @param allowed  whether the content may proceed to the LLM provider
 * @param content  masked/sanitized content (equals input when unchanged)
 * @param reason   human-readable explanation when blocked
